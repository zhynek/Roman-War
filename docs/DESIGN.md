...
| 9 — Visual & command layer | Building/unit art, right-click detail and garrison views, troop classes tied to their buildings, click-to-attack with animated battle playback | **Requested 2026-08-26, not started.** Requirements, existing data, open decisions and sequencing in [`docs/HANDOFF.md`](HANDOFF.md) §5 |
