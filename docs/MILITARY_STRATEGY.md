...
5. **Matchups** — the counter table (§2), weighted by what the *enemy* actually brought: a pike
   ...
   Every unit card counts as one slot, whatever its headcount, so eighteen elephants weigh as
   much in the line as a hundred and sixty pikemen.
...
- **Pikes over cavalry (1.67)** and **spears over cavalry (1.40)**. Horses will not charge a steady hedge of
  points. Alexander's phalanx was the anvil at Gaugamela (331 BC); at the Hydaspes (326 BC) it
  received Porus's chariots and elephants; at Magnesia (190 BC) the Seleucid cataphracts broke
  a Roman legion but never the pikes. With the *phalanx* attribute the edge is larger still.
...
| War Cry (`warcry`) | attacking +8% | Works itself into a fury before the charge: harder-hitting when attacking, no help when standing to receive. |
| Frightens Infantry (`frighten_infantry`) | matchups: infantry +10%, spear +10%, missile +10%, peasant +15% | Foot soldiers who have never seen the like of it waver before contact. |
| Frightens Horses (`frighten_cavalry`) | matchups: cavalry +15%, horse archer +10%, chariot +15%, general bodyguard +15% | Horses refuse to close with the smell and noise: elephants and camels have broken cavalry that had never met them. |
| Woodsmen (`can_hide_forest`) | terrain: forest +20% | At home under the trees, where a column marching through can be ambushed: the lesson of the Litana forest and the Teutoburg. |
...
| Sappers (`can_sap`) | assault +20% | Undermines and breaches walls, so an assault reaches the streets with less blood on the ramparts. |
...
- **Kit.** Weapon and armour levels, up to 3 each (an armourers' guild allows one more), each worth a point of attack or defence — an armoury is worth roughly a chevron and a half to a line unit. They come from
...
| Tribal Forges — Master Smith's Hall | minor city | 1 | 1 |
  ...
  Forge temples (Vulcan, Hephaestus, Ptah, Atar, Gobannos) add to the same pool. Units are
  issued kit when recruited; **Retrain garrison** refits every unit in the town to its current
  standard (never taking better kit away) and refills the depleted ones for half price.
...
| chain | tiers | unlocks | drill | law | kit |
|---|---|---|---|---|---|
| Roman Infantry Training (roman) | 5 | infantry, spears, pikes | 0/1/1/2/2 | 0/0/2/3/4 | 0w0a/0w0a/0w0a/1w0a/1w1a |
| City Infantry Training (greek, eastern, carthaginian, egyptian) | 5 | infantry, spears, pikes | 0/1/1/2/2 | 0/0/2/3/4 | 0w0a/0w0a/0w0a/1w0a/1w1a |
| Warband Training (barbarian, neutral) | 3 | infantry, spears, pikes | 0/1/1 | 0/0/2 | 0w0a/0w0a/0w0a |
| Roman Cavalry Training (roman) | 3 | cavalry, horse archers, chariots, elephants | 0/0/1 | 0/0/0 | 0w0a/0w0a/0w0a |
| Eastern Horse Breeding (eastern) | 4 | cavalry, horse archers, chariots, elephants | 0/0/0/1 | 0/0/0/0 | 0w0a/0w0a/0w0a/0w0a |
| City Cavalry Training (greek, carthaginian, egyptian) | 3 | cavalry, horse archers, chariots, elephants | 0/0/1 | 0/0/0 | 0w0a/0w0a/0w0a |
| Tribal Horse Pens (barbarian) | 2 | cavalry, horse archers, chariots, elephants | 0/1 | 0/0 | 0w0a/0w0a |
| Eastern Archery Tradition (eastern, egyptian) | 3 | archers, slingers | 0/0/1 | 0/0/0 | 0w0a/0w0a/0w0a |
| Skirmisher Training (roman, greek, carthaginian) | 2 | archers, slingers | 0/1 | 0/0 | 0w0a/0w0a |
| Hunter Training (barbarian) | 2 | archers, slingers | 0/1 | 0/0 | 0w0a/0w0a |
| Siege Engineering (roman, greek, eastern, carthaginian, egyptian) | 3 | artillery | 0/0/0 | 0/0/0 | 0w0a/0w0a/1w0a |
...
and remount herds, native levies and elephant establishments are the only relief.
...
in *some* region (horses, iron, elephants), the era, battles won or lost — and **arms faced**: a
faction must have met cavalry in two battles before it can drill against cavalry, met legions
before it can learn to ambush them. Rome copied the Iberian sword and the Celtic mail shirt
from the people who used them on her; that is the mechanic.
...
| doctrine | cost / turns | requires | effects | history |
|---|---|---|---|---|
| **Sarissa Drill** — practised from the start by macedon, thracia, seleucia | 1500 / 2 | — | pike defense +1; pike vs cavalry +5% | Philip II gave Macedon the sarissa, a two-handed pike of five to six metres, and drilled poor farmers until sixteen ranks could move as one. His son took it to the Indus. |
...
| **Companion Wedge** | 2600 / 3 | stables tier 2, horses region | cavalry charge +2; cavalry vs infantry +10% | Philip's and Alexander's Companion cavalry charged in a wedge, the point aimed at a seam in the enemy line: Chaeronea (338 BC) and Gaugamela (331 BC) were decided by it, with the phalanx as the anvil. |
| **Torsion Artillery** | 3000 / 4 | siege workshop tier 2 | siege missile attack +3; assault +10%; wall defense +10% | Torsion catapults, powered by twisted sinew, appear under Dionysius I of Syracuse (c. 399 BC); by the siege of Rhodes (305 BC) Hellenistic engineers were building them by the hundred, and every city wall answered with its own. |
| **Thureophoroi Reform** | 2000 / 3 | 1 battle lost | infantry on hills +10%; infantry on forest +10%; pike on hills +10% | After Cynoscephalae (197 BC) and Pydna (168 BC) showed what broken ground did to a pike block, Greek states raised looser-order thureophoroi with the oval shield and trained the phalanx to keep its intervals on a slope. Learned from a defeat. |
| **Elephant Corps** | 3500 / 4 | stables tier 3, elephants region | elephant morale +2; elephant vs infantry +10%; elephant upkeep -15% | The Seleucids kept a permanent elephant corps from Indian stock; four hundred beasts screened the flanks at Ipsus (301 BC), and Raphia (217 BC) saw the only recorded battle between African and Indian elephants. |

### Eastern

| doctrine | cost / turns | requires | effects | history |
|---|---|---|---|---|
| **Composite Bow Mastery** — practised from the start by parthia, armenia | 1500 / 2 | — | horse archer missile attack +1 | The recurved composite bow of horn, wood and sinew, drawn from the saddle, was the weapon of the Iranian plateau and the steppe. At Carrhae (53 BC) Surena's archers emptied their quivers into seven legions and were resupplied by camel. |
...
| **Sacred Band Drill** | 3000 / 4 | barracks tier 3 | spear morale +2, defense +1 | The Sacred Band was Carthage's one native regiment: sons of the great houses, armoured and drilled as hoplites, who died almost to a man at the Crimissus (341 BC) rather than break. |

### Egyptian

| doctrine | cost / turns | requires | effects | history |
|---|---|---|---|---|
| **Ptolemaic Phalanx** — practised from the start by egypt | 1500 / 2 | — | pike defense +1; spear defense +1; spear vs cavalry +10% | The Ptolemies settled Macedonian and Greek soldiers on Nile land in return for service, and drilled them in the sarissa; at Raphia (217 BC) that phalanx, stiffened with twenty thousand Egyptians, broke the Seleucid centre. |
...
| **Horse Lords** (scythia only) — practised from the start by scythia | 1500 / 2 | horses region | horse archer on steppe +10%; horse archer upkeep -15% | The Scythians and their Sarmatian successors lived in the saddle; Darius could not catch them in 513 BC and neither could anyone else. Every family bred its own remounts. |

### Shared between cultures

| doctrine | cost / turns | requires | effects | history |
|---|---|---|---|---|
| **Mail Armour** | 2400 / 4 | iron region | infantry defense +1; spear defense +1 | The riveted mail shirt was a Celtic invention of the third century BC; Rome copied it as the lorica hamata and wore it for the next four hundred years. It needs iron, and a great deal of a smith's time. |
...
| **Veteran Cadres** | 2800 / 4 | 5 battles won | all recruits +1 xp | Rome's evocati, veterans recalled to stiffen new legions, and the Hellenistic argyraspides show the same idea: seed every new unit with men who have seen a battle. |
...
- **Triumph and shock.** A *decisive* battle — at least 1,500 men engaged, and the loser destroyed or
  ...
  victor gains +5 order for 4 turns (a triumph), every town of the loser −8 for 4 turns. Rome after Cannae armed slaves and forbade mourning; the mechanic is that shock.
