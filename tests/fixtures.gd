...
static func data() -> GameData:
	...
	# against the shipped table, not a stand-in.
	...
	var chains := [
		...
		},
		{
			...
			"levels": [
				...
				{"id": "barracks_2", "name": "Drill Yard", "min_settlement_level": "town", "cost": 800, "build_turns": 2, "effects": {"martial": 4, "civic": -2, "burden": 1, "drill": 1, "recruit_xp": 1, "weapon_upgrade": 1}, "description": ""},
			],
		},
		{
	...
	game_data.techniques = {
		...
		# Warcraft: military techniques carry a `war` block of per-class tables
		# beside the flat effects, and may read the war record as a prerequisite.
		"test_horse_drill": {
			"id": "test_horse_drill", "name": "Horse Drill", "domain": "warcraft",
			"historical_basis": "fixture",
			"start_adopted": {"cultures": [], "factions": []},
			"origin_cultures": ["roman"],
			"prerequisites": {"building_kind": "stables", "building_level": 1, "resource": "", "hidden_resource": "", "coastal": false, "techniques": []},
			"adoption": {"cost": 1000, "turns": 2},
			"culture_resistance": {},
			"effects": {"pursuit_pct": 10},
			"war": {"class_stats": [{"class": "cavalry", "attack": 3}], "upkeep_pct": [{"class": "cavalry", "pct": -20}]},
		},
		"test_camp_law": {
			"id": "test_camp_law", "name": "Camp Law", "domain": "warcraft",
			"historical_basis": "fixture",
			"start_adopted": {"cultures": [], "factions": []},
			"origin_cultures": ["roman"],
			"prerequisites": {"building_kind": "", "building_level": 0, "resource": "", "hidden_resource": "", "coastal": false, "techniques": [], "battles_won": 1},
			"adoption": {"cost": 800, "turns": 1},
			"culture_resistance": {},
			"effects": {"garrison_order_pct": 20, "siege_equipment_turns_delta": -1, "movement_points": 0.5, "levy_strain_pct": -50},
		},
		"test_tribal_fury": {
			"id": "test_tribal_fury", "name": "Tribal Fury", "domain": "warcraft",
			"historical_basis": "fixture",
			"start_adopted": {"cultures": [], "factions": []},
			"origin_cultures": ["barbarian"],
			"prerequisites": {"building_kind": "", "building_level": 0, "resource": "", "hidden_resource": "", "coastal": false, "techniques": [], "faced": {"class": "spear", "battles": 2}},
			"adoption": {"cost": 500, "turns": 1},
			"culture_resistance": {},
			"effects": {"attacking_pct": 10},
			"war": {"recruit_xp": [{"class": "infantry", "xp": 1}], "fatigue_immune": true},
		},
		"test_royal_stud": {
			"id": "test_royal_stud", "name": "Royal Stud", "domain": "warcraft",
			"historical_basis": "fixture",
			"start_adopted": {"cultures": [], "factions": []},
			"origin_cultures": [],
			"factions": ["blue"],
			"prerequisites": {"building_kind": "", "building_level": 0, "resource": "", "hidden_resource": "", "coastal": false, "techniques": [], "battles_won": 1},
			"adoption": {"cost": 300, "turns": 1},
			"culture_resistance": {},
			"effects": {"escape_pct": 10},
		},
	}
...
static func _faction(game_data: GameData, capital: String) -> Dictionary:
	return {
		...
		"war_record": NewGame.empty_war_record(), "war_mood": null,
	}


static func adopt_technique(campaign_state: Dictionary, faction_id: String, technique_id: String) -> void:
	## Grant a practiced technique outright (as the 270 BC endowment does).
	KnowledgeRules.knowledge_of(campaign_state, faction_id)[technique_id] = {
		"stage": "adopted", "turn": 0, "progress": 0, "discount_pct": 0.0,
	}
